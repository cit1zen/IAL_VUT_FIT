...
*/
    // EMPTY -> posledny a prvy prvok ukazuju na jedno miesto
...
*/
    ...
    {
        //Lebo v realite sa kruhovo hybeme po tom poli
        //Aj ked fronta ma zaciatok a koniec
        q->f_index=(q->f_index+1)%QUEUE_SIZE;
    }
